...
#define KM_ERR_FAIL_BC_CONFIG_NET       MAKE_ERR(PROD_CLIENT,   0x0311)     ///< 广播配置网络失败
#define KM_ERR_INVALID_BC_CONFIG_NET    MAKE_ERR(PROD_CLIENT,   0x0311)     ///< 广播配置网络参数错误
...
#define KM_ERR_FTP_APP_CANNOT_LOGIN     MAKE_ERR(PROD_FTP,   0x0077)    ///< 不允许登录
